...
# Distribution of timeliness data when there is a due date

```{python}
fig = px.scatter(dfx, x="duedate_time_diff", y="graded_time_diff", width=800, height=500,
...
- 47% of data is along bottom edge (graded within 5 days)
- Bottom edge is where timeliness issues are found.
- 22% of all data in “the box” them were graded 7 or more days after the due date (and within 5 days of each other)
- 15% of all data in “the box” them were graded 14 or more days after the due date (and within 5 days of each other)

# Timeliness Data - No Due Date
...
- 72% of data is along bottom edge (graded within 5 days), compared to 47% when there was a due date.
- Something must be qualitatively different between the two sets.
